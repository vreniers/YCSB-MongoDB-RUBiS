...
public class MongoDbClient extends DB {
  ...
  public Status insert(String table, String key,
    ...
    try {
      MongoCollection<Document> collection = database.getCollection(table);
      Document toInsert = createDocument(key, values);
  ...
  /**
   * Creates a user, cascade effect creates Items, Bids, Comments, etc.
   * @param key
   * @param values
   * @return
   */
  private Document createDocument(String key, Map<String, ByteIterator> values) {
